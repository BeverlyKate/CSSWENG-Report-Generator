...
describe("Main Controller", () => {
    ...
    describe("Home", () => {
        it("should render home if username and password is correct", async function() {
            ...
            // Create a mock request object
            const mockReq = { 
                body: { username: "Hatdog", password: "hatdog" },
                headers: {
                host: 'localhost:3000',
                connection: 'keep-alive',
                'content-length': '16852305',
            ...
            const hashedPassword = "$2b$10$AQl0pFrWNYzriQRDeNvYBOCIr8rYmU8Ut/FHmhhQPoQbZtTXfsX4y"

            const result = await bcrypt.compare(mockReq.password, hashedPassword);
    
            expect(bcrypt.compare).toHaveBeenCalledWith(mockReq.password, hashedPassword);
